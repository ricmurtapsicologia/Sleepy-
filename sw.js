const CACHE='sono-em-dia-v1';
const ASSETS=['./','./index.html','./css/styles.css','./js/content.js','./js/app.js','./assets/favicon.svg','./assets/social-preview.svg','./manifest.webmanifest'];
